    ...
    categories: [
      {
        ...
        subtopics: [
          ...
          { name: "Group Theory", url: "alg/group-basic.html" },
          { name: "Ring Theory", url: "alg/ring-basic.html" }
        ]
      },
      {
        name: "Topology",
      ...
      },
      {
        ...
        id: "analysis-sub",
        subtopics: [
          { name: "Real Analysis", url: "analy/real-analysis-basic.html" },
          { name: "Complex Analysis", url: "analy/complex-analysis-basic.html" }
        ]
      }
    ]
  },
