...
const sidebarData = {
  labnote: {
    title: "Mathematics",
    overviewUrl: "labnote.html", // 메인 페이지 URL 추가
    categories: [
      {
        name: "Quantum Acoustics",
        id: "quantum-acoustics-sub",
        subtopics: [
          { name: "Phononic Crystal", url: "qa/pnc.html" }
        ]
      },
      {
        name: "Circuit QED",
        id: "cqed-sub",
        subtopics: [
          { name: "Superconducting Resonator", url: "cqed/scresonator.html" }
        ]
      }
    ]
  }
